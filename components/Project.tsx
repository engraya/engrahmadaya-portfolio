...
function Project({
  ...
  return (
    ...
    >
      ...
      <h3 className="text-2xl font-semibold whitespace-nowrap m-4">{title}</h3>
        <div className="pt-4 pb-7 px-1 sm:pl-6 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]">
