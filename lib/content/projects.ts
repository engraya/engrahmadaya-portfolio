...
export const projects = [
    ...
    {
      id: 26,
      title: "API service (template) — replace with your backend project",
      description:
        "Placeholder: describe your REST or GraphQL API here. Replace or remove ids 26–27 in lib/content/projects.ts with your real backend services.",
      image: pagemark,
      ...
      endpoints: [
        ...
        { method: "GET", path: "/v1/resources", purpose: "List resources" },
        { method: "POST", path: "/v1/resources", purpose: "Create resource" },
      ],
      architectureSummary: [
        "HTTP gateway / load balancer",
    ...
    {
      id: 27,
      title: "Second API (template) — microservice or domain boundary",
      description:
        "Second placeholder for a standalone backend (auth, billing, ingestion, etc.). Delete this entry when you publish real API projects.",
      image: aiPrompts,
      tags: ["TypeScript", "Node.js", "Prisma", "OpenAPI"],
      category: "API",
      kind: "backend" as const,
      github: "https://github.com/engraya",
      apiDocs: "https://example.com/openapi.json",
      baseUrl: "https://api.example.com",
      auth: "API keys and rate limiting",
      deployment: "Your cloud host",
      endpoints: [
        {
          method: "POST",
          path: "/webhooks/events",
          purpose: "Verified inbound webhooks",
        },
        { method: "GET", path: "/v2/status", purpose: "Versioned status" },
      ],
      architectureSummary: [
        "Public REST surface",
