...
export const projects = [
    {
      ...
      description: "A collaborative workspace API for organizing projects, assigning tasks, and tracking delivery. Project membership connects tasks, labels, and conversations, with searchable work queues and paginated results.",
      image: "",
      tags: ["NestJS", "TypeScript", "PostgreSQL", "Prisma", "JWT", "Swagger", "Vitest", "Docker"],
      category: "REST API",
      kind: "backend",
      github: "https://github.com/engraya/task-management-api",
      webapp: "https://task-management-api-tu8w.onrender.com",
      baseUrl: "https://task-management-api-tu8w.onrender.com/api/v1",
      apiDocs: "https://task-management-api-tu8w.onrender.com/api/docs",
      highlights: ["Project membership & task assignment", "Status, priority, label & assignee filters", "Validated requests & global rate limiting"],
      auth: "JWT bearer tokens protect requests. Project routes check membership, and assignees must belong to the project. Owner and member roles are stored; management actions currently use membership checks rather than owner-only permissions.",
      deployment: "Hosted on Render. Docker packages the service; GitHub Actions runs lint, database-backed tests, compilation, and container checks. A separate workflow publishes images to GHCR.",
      endpoints: [
        { method: "POST", path: "/api/v1/projects", purpose: "Create a project and add its creator as an owner member." },
        { method: "GET", path: "/api/v1/projects/:projectId/tasks", purpose: "Search and paginate tasks by status, priority, assignee, or label." },
        { method: "PATCH", path: "/api/v1/projects/:projectId/tasks/:taskId/status", purpose: "Move a task through TODO, IN_PROGRESS, IN_REVIEW, and DONE." },
        { method: "POST", path: "/api/v1/auth/login", purpose: "Authenticate and receive a JWT access token." },
        { method: "POST", path: "/api/v1/projects/:projectId/tasks/:taskId/comments", purpose: "Add a comment to a task within a project." },
        { method: "GET", path: "/api/v1/health", purpose: "Read application status and timestamp." },
      ],
      architectureSummary: [
    ...
    },
    {
      ...
      description: "An academic administration API that connects student records with course registration, assessment results, and attendance. It calculates credit-weighted GPA and cumulative GPA while giving administrators and staff distinct permissions.",
      image: "",
      tags: ["NestJS", "TypeScript", "PostgreSQL", "Prisma", "JWT", "Swagger", "Vitest", "Docker"],
      category: "REST API",
      kind: "backend",
      github: "https://github.com/engraya/student-management-api",
      webapp: "https://student-management-api-wwhb.onrender.com",
      baseUrl: "https://student-management-api-wwhb.onrender.com/api/v1",
      apiDocs: "https://student-management-api-wwhb.onrender.com/docs",
      highlights: ["Academic records, results & attendance", "Credit-weighted GPA & cumulative GPA", "Admin / staff permissions & rotating tokens"],
      auth: "JWT bearer authentication with rotating refresh tokens and logout. ADMIN and STAFF role guards control privileged operations. Includes account disabling, login lockout, email verification, and password reset; login does not require email verification.",
      deployment: "Hosted on Render. Docker Compose supports the API and PostgreSQL. GitHub Actions runs lint, unit and end-to-end tests, application and image builds; a separate workflow publishes containers to GHCR.",
      endpoints: [
        { method: "GET", path: "/api/v1/students", purpose: "Search, filter, sort, and paginate student records." },
        { method: "POST", path: "/api/v1/academic/registrations", purpose: "Register a student for a course." },
        { method: "GET", path: "/api/v1/academic/students/:studentId/cgpa", purpose: "Calculate cumulative GPA with semester breakdowns." },
        { method: "POST", path: "/api/v1/auth/refresh", purpose: "Rotate a refresh token and issue a new token pair." },
        { method: "POST", path: "/api/v1/academic/attendance", purpose: "Allow administrators and staff to record attendance." },
        { method: "GET", path: "/api/v1/audit-logs", purpose: "Allow administrators to inspect authentication and user-management events." },
        { method: "GET", path: "/api/v1/health", purpose: "Check database connectivity." },
      ],
      architectureSummary: [
    ...
    {
      id: 8,
      title: "Creatify_AI – Instantly Generate SEO-Friendly Content for Web with AI",
      description:
        "Creatify_AI empowers businesses, marketers, and creators with high-quality, SEO-friendly contents in seconds",
      image: creatifyAI,
      tags: ["React", "Nextjs", "Typescript", "TailwindCSS", "Shadcn UI", "PostgreSQL", "Clerk", "Stripe", "Docker", "AI"],
      category: "web app",
      kind: "fullstack" as const,
